        ...
        <div :class="isOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
            ...
            <div class="flex items-center justify-center mt-8">
                <div class="flex items-center">
                    ...
                    <router-link to="/">
                        <span class="mx-2 text-2xl font-semibold text-white">Travel</span>
                    </router-link>
                </div>
            </div>
            ...
            <nav class="mt-10">
                ...
                <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
                    :class="[$route.name === 'UserList' ? activeClass : inactiveClass]" to="/user/list">
                    <svg class="w-5 h-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <span class="mx-4">User List</span>
                </router-link>
                <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
                    :class="[$route.name === 'AdminCategoryList' ? activeClass : inactiveClass]" to="/category/list">
                    <svg class="w-5 h-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M5 3C3.89543 3 3 3.89543 3 5V7C3 8.10457 3.89543 9 5 9H7C8.10457 9 9 8.10457 9 7V5C9 3.89543 8.10457 3 7 3H5Z"
                            fill="currentColor" />
                    ...
                    <span class="mx-4">Category List</span>
                </router-link>
                <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
                    :class="[$route.name === 'AdminPostList' ? activeClass : inactiveClass]" to="/post/list">
                    <svg class="w-5 h-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <span class="mx-4">Post List</span>
                </router-link>

                <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
                    :class="[$route.name === 'productAdd' ? activeClass : inactiveClass]" to="/product/add">
                    ...
                    <span class="mx-4">Product Add</span>
                </router-link>
