...
<template>
    <div class="max-w-4xl px-10 py-6 bg-white rounded-lg shadow-md">
        <div class="flex justify-between items-center">
            ...
            <a class="px-2 py-1 bg-gray-600 text-gray-100 font-bold rounded hover:bg-gray-500" href="#">{{
                data.category.name
            }}</a>
        </div>
        <div class="mt-2">
        ...
        <div class="flex justify-between items-center mt-4">
            ...
            <div>
                <a class="flex items-center" href="#">
                    <img class="mx-4 w-10 h-10 object-cover rounded-full hidden sm:block" v-if="data.image"
